...
/****** Object:  Database [Ventas]    Script Date: 03/09/2012 07:51:29 ******/
IF  EXISTS (SELECT name FROM sys.databases WHERE name = N'Ventas')
...
/****** Object:  Database [Ventas]    Script Date: 03/09/2012 07:51:30 ******/
CREATE DATABASE [Ventas] ON  PRIMARY 
( NAME = N'Ventas', FILENAME = N'C:\Ventas.mdf' , SIZE = 3072KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'Ventas_log', FILENAME = N'C:\Ventas_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
